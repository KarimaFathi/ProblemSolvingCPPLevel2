...
int countPositiveNumbersIntoArray(int arraySource[100], int arrLength) {
    int counter = 0;
    for (int i = 0; i < arrLength; i++) {
        if (arraySource[i] >= 0) {
            counter++;
...
int main()
{
    ...
    cout << "The number of positive numbers is : " << countPositiveNumbersIntoArray(array1, arrLength) << endl;
